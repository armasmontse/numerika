				...
				<div class="footer__container">
					<div class="group-one">
						...
						<a href="<?php echo BLOGURL ?>">
							<img class="footer__logo" src="<?php echo THEMEURL ?>images/footer/logo-footer-numerika.svg" alt="">
						</a>

						<div class="footer__contacto">
							<a href="mailto:contacto@numerika.mx">contacto@numerika.mx</a>
						</div>
					</div>
					<div class="group-two">
						<div class="column-one">
							<div class="footer__contacto--mobile">
								<a href="mailto:contacto@numerika.mx">contacto@numerika.mx</a>
							</div>
							<div class="info">
								Av. Colonia del Valle #511, <br />
                                Col. Del Valle Centro, Delegación Benito Juárez, 03100, Ciudad de México.<br />
								T. 6363 6297 y 4431 3755
							</div>
						</div>
						...
						<div class="column-two">
							...
							<div class="privacidad">
								<a href="<?php echo BLOGURL ?>/politica-privacidad">Política de privacidad</a>
							</div>
						</div>
					</div>
				</div>
